...
import { ArrowLeft, Plus, Search, Download, Trash2, Eye, FileText, ImageIcon, Video, File } from "lucide-react"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Media Library</h1>
