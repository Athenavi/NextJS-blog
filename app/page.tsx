            ...
            <div className="grid gap-6 md:grid-cols-2">
              {articles.map((article) => (
                <Link key={article.id} href={`/articles/${article.id}`} className="block group">
                  <Card className="border-slate-200 dark:border-slate-700 transition-colors group-hover:border-blue-300 dark:group-hover:border-blue-700">
                    <CardHeader>
                      <CardTitle className="text-slate-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                        {article.title}
                      </CardTitle>
                      <CardDescription>
